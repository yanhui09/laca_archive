...
p_otus_count <- df_otus_count %>%
  ...
  geom_segment(data = data.frame(xs=0,xe=5000,ys=95,ye=95), aes(x=xs, xend=xe, y=ys, yend=ye), linetype = "dashed") + #nolint
  geom_segment(data = data.frame(xs=5000,xe=5000,ys=-Inf,ye=95), aes(x=xs, xend=xe, y=ys, yend=ye), linetype = "dashed") + #nolint
  geom_segment(data = data.frame(xs=0,xe=5000,ys=97,ye=97), aes(x=xs, xend=xe, y=ys, yend=ye), linetype = "dashed") + #nolint
  geom_segment(data = data.frame(xs=5000,xe=5000,ys=-Inf,ye=97), aes(x=xs, xend=xe, y=ys, yend=ye), linetype = "dashed") + #nolint
